...
public class HFileGenerator {
    private static Logger LOG = LoggerFactory.getLogger(HFileGenerator.class);
    ...
    public static class HFileMapper extends Mapper<Object, Text, ImmutableBytesWritable, Put> {
        ...
        protected void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            JsonObject tableDetail = new JsonParser().parse(context.getConfiguration().get("tableStructure")).getAsJsonObject();
    ...
    public static void main(String[] args) throws Exception {
        ...
        LOG.info("tableStructure = " + tableStructure);
