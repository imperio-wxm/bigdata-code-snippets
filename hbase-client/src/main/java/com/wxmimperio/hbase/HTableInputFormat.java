...
public class HTableInputFormat extends HTableInputFormatBase implements Configurable {

    @SuppressWarnings("hiding")
    private static final Log LOG = LogFactory.getLog(HTableInputFormat.class);
